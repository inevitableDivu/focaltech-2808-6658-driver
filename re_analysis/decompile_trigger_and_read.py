...
def disasm_func_full(start_va, max_insns=60):
...
# 0x180008ce0 (Trigger Scan)
disasm_func_full(0x180008ce0, 60)
# 0x18000a2d4 (Read image data)
disasm_func_full(0x18000a2d4, 60)
# 0x180008c64 (Post scan)
disasm_func_full(0x180008c64, 40)
