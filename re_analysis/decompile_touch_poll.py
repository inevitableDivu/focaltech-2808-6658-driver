...
def disasm_func(start_va, count=40):
    ...
    for insn in cs.disasm(code, start_va):
        ...
        cur += 1
        if cur >= count or insn.mnemonic == 'ret':
            break

# 0x180002c24 (poll status)
disasm_func(0x180002c24, 30)
# 0x180003320 (touch state)
disasm_func(0x180003320, 30)
